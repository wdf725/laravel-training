                      ...
                      @forelse ($vehicles as $item)
                          <tr>
                              ...
                              <td class="text-center">
                                <a href="{{ route('vehicle.show', $item->id) }}" class="btn btn-sm btn-info">Show</a>
              <a href="{{ route('vehicle.edit', $item->id) }}" class="btn btn-sm btn-warning">Edit</a>
              <!-- Trigger Modal -->
